      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6 pt-20 pb-32">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <h1 className="font-display text-4xl md:text-5xl lg:text-6xl mb-48 animate-fade-in-up"
                style={{ 
                  color: 'var(--neutral-900)',
                  animationDelay: '0.1s',
                  animationFillMode: 'backwards'
            ...
            <p className="font-body text-lg lg:text-xl mb-80 leading-relaxed max-w-3xl mx-auto animate-fade-in-up"
               style={{ 
